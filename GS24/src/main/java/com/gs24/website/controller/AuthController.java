...
public class AuthController {
	...
	public String registerGET(RedirectAttributes redirectAttributes) {
		if (SecurityContextHolder.getContext().getAuthentication().isAuthenticated()) {
			redirectAttributes.addFlashAttribute("message", "로그아웃 후에 진행해주세요.");
	...
	@GetMapping("/find-id")
	public String findIdGET(RedirectAttributes redirectAttributes) {
		if (SecurityContextHolder.getContext().getAuthentication().isAuthenticated()) {
			redirectAttributes.addFlashAttribute("message", "로그아웃 후에 진행해주세요.");
			return "redirect:/food/list";
		}
	...
	@GetMapping("/find-pw")
	public String findPwGET(RedirectAttributes redirectAttributes) {
		if (SecurityContextHolder.getContext().getAuthentication().isAuthenticated()) {
			redirectAttributes.addFlashAttribute("message", "로그아웃 후에 진행해주세요.");
			return "redirect:/food/list";
		}
