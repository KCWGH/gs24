...
<c:if test="${not empty message}">
  ...
  <div id="discountForm"></div>
	<br>
	<div>
		<label for="couponAmount">수량: </label> <input type="number" name="couponAmount" required> 매<br>
    ...
    <input type="datetime-local" id="couponExpiredDate" name="couponExpiredDate" ><br>
