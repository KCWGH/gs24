  ...
  $(document).ready(function() {
    $('form').submit(function(event) {
      ...
      grecaptcha.ready(function() {
        grecaptcha.execute('6LfrNrAqAAAAANk1TA-pg2iX6Zi9mEDxF1l1kZgR', {
          action: 'signup'
        }).then(function(token) {
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<button type="button" onclick="checkEmail()">이메일 중복 확인</button> <br>
				...
				<tr>
					...
					<td>
						...
						<button type="button" onclick="checkPhone()">전화번호 중복 확인</button> <br>
